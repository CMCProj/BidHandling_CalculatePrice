...
export class CalculatePrice {
    ...
    public static GetFixedPriceRate(): void {
        ...
        Data.FixedPricePercent = Number(decimal.div(directConstPrice).times(100).toFixed(5, 0)) // 고정금액 비중 계산 / 고정금액 소수점 5자리 수에서 절사 (23.02.06)
    }
    ...
    public static CalculateRate(personalRate: any, balancedRate: any): void {
        ...
        this.targetRate = Number(new Decimal(this.targetRate).toFixed(5, 0))
        //소수점 아래 5자리 남기고 절사
    }
