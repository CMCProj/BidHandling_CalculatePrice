    ...
    public static SubstitutePrice(): void {
        ...
        for (let key in bidT5) {
            if (
                ...
                Data.Bidding.get(bidT5[key]['C4']['_text'].slice(1, -1))
            ) {
                bidT5[key]['C8']['_text'] = Data.Bidding.get(
                    bidT5[key]['C4']['_text'].slice(1, -1)
                ).toString()
            } else if (Data.Rate1.get(bidT5[key]['C4']['_text'].slice(1, -1))) {
                bidT5[key]['C8']['_text'] = Data.Bidding.get(
                    bidT5[key]['C4']['_text'].slice(1, -1)
                ).toString()
            }
