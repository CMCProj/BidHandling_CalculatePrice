...
var CalculatePrice = (exports.CalculatePrice = /** @class */ (function () {
    ...
    CalculatePrice.Calculation = function () {
        var bidString = fs.readFileSync(Data_1.Data.folder + '\\Setting_Json.json', 'utf-8')
    ...
    CalculatePrice.GetFixedPriceRate = function () {
        ...
        Data_1.Data.FixedPricePercent =
            Math.trunc((fixCostSum / directConstPrice) * 100 * 10000) / 10000 // 고정금액 비중 계산 / 고정금액 소수점 5자리 수에서 절사 (23.02.06)
    }
    ...
    CalculatePrice.GetWeight = function () {
        ...
        var varCostSum =
            ...
            Data_1.Data.RealPriceOutputExpense //총 합계금액(-,PS,표준시장단가 제외)
        var weight
        var maxWeight = 0
        var weightSum = 0
    ...
    CalculatePrice.SetExcludingPrice = function () {
        ...
        var InvestExSum =
            ...
            Data_1.Data.ExcludingExpense //조사 제요율적용제외공종
