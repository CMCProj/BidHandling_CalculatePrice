    ...
    static SubstitutePrice() {
        ...
        for (let key in bidT5) {
            if (bidT5[key]['C4']['_text'].slice(1, -1) !== '이윤' &&
                Data_1.Data.Bidding.get(bidT5[key]['C4']['_text'].slice(1, -1))) {
                bidT5[key]['C8']['_text'] = Data_1.Data.Bidding.get(bidT5[key]['C4']['_text'].slice(1, -1)).toString();
            }
            else if (Data_1.Data.Rate1.get(bidT5[key]['C4']['_text'].slice(1, -1))) {
                bidT5[key]['C8']['_text'] = Data_1.Data.Bidding.get(bidT5[key]['C4']['_text'].slice(1, -1)).toString();
            }
        }
