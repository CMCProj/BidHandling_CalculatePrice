            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 20, 6).value = Data_1.Data.Rate1.get('공사이행보증서발급수수료') + ' %';
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 21, 6).value = Data_1.Data.Rate1.get('건설하도급보증수수료') + ' %';
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 22, 6).value = Data_1.Data.Rate1.get('건설기계대여대금 지급보증서발급금액') + ' %';
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 20, 8).value = Data_1.Data.Investigation.get('공사이행보증서발급수수료'); //다-12. 공사이행보증수수료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 21, 8).value = Data_1.Data.Investigation.get('건설하도급보증수수료'); //다-13. 하도급대금지급 보증수수료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 22, 8).value = Data_1.Data.Investigation.get('건설기계대여대금 지급보증서발급금액'); //다-14. 건설기계대여대금 지급보증서 발급금액
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 22, 19).value = Data_1.Data.Bidding.get('건설기계대여대금 지급보증서발급금액'); //다-14. 건설기계대여대금 지급보증서 발급금액
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 12, 20).value = FillCostAccount.GetRate('국민건강보험료') + ' %'; //다-4. 국민건강보험료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 13, 20).value = FillCostAccount.GetRate('노인장기요양보험') + ' %'; //다-5. 노인장기요양보험
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 14, 20).value = FillCostAccount.GetRate('국민연금보험료') + ' %'; //다-6. 국민연금보험료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 15, 20).value = FillCostAccount.GetRate('퇴직공제부금') + ' %'; //다-7. 퇴직공제부금
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 16, 20).value = FillCostAccount.GetRate('산업안전보건관리비') + ' %'; //다-8. 산업안전보건관리비
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 20, 20).value = FillCostAccount.GetRate('공사이행보증서발급수수료') + ' %'; //다-12. 공사이행보증수수료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 21, 20).value = FillCostAccount.GetRate('건설하도급보증수수료') + ' %'; //다-13. 하도급대금지급 보증수수료
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 22, 20).value = FillCostAccount.GetRate('건설기계대여대금 지급보증서발급금액') + ' %'; //다-14. 건설기계대여대금 지급보증서 발급금액
                        ...
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 27, 20).value = FillCostAccount.GetRate('제요율적용제외공종') + ' %'; //3.2 제요율적용제외공종
                        ExcelHandling_1.ExcelHandling.GetCell(sheet, 29, 20).value = FillCostAccount.GetRate('공사손해보험료') + ' %'; //5. 공사손해보험료
